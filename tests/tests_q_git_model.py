...
#        commits = self.TEST_wallace_branch_model.get_git_model().get_commits()
    ...
    def all_tests(self):
        self.test_get_current_branch()
        self.test_default_branch()
        self.test_row_count()
        self.test_column_count()
        self.test_data_message()
        self.test_data_message()
        self.test_data_author_date()
        self.test_data_author()
        self.test_data_committer()
        self.test_get_branches()
        self.test_parent()
        self.test_set_branch_twice_fails()
        self.test_filter_message()
        self.test_filter_author()
